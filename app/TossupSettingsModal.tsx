    ...
    <ScrollView>
      <Accordion overflow="scroll" type="multiple">
        ...
        <Accordion.Item value="a2">
          ...
          <Accordion.Content>
            <CategoryCheckBox category='Literature' categories={tossupSettings.cat} addCategory={tossupSettings.addCat} removeCategory={tossupSettings.rmCat}   />
            <CategoryCheckBox category='History' categories={tossupSettings.cat} addCategory={tossupSettings.addCat} removeCategory={tossupSettings.rmCat}   />
            <CategoryCheckBox category='Science' categories={tossupSettings.cat} addCategory={tossupSettings.addCat} removeCategory={tossupSettings.rmCat}   />
            <CategoryCheckBox category='Fine Arts' categories={tossupSettings.cat} addCategory={tossupSettings.addCat} removeCategory={tossupSettings.rmCat}   />
            <CategoryCheckBox category='Religion' categories={tossupSettings.cat} addCategory={tossupSettings.addCat} removeCategory={tossupSettings.rmCat}   />
            <CategoryCheckBox category='Mythology' categories={tossupSettings.cat} addCategory={tossupSettings.addCat} removeCategory={tossupSettings.rmCat}   />
            <CategoryCheckBox category='Philosophy' categories={tossupSettings.cat} addCategory={tossupSettings.addCat} removeCategory={tossupSettings.rmCat}   />
            <CategoryCheckBox category='Social Science' categories={tossupSettings.cat} addCategory={tossupSettings.addCat} removeCategory={tossupSettings.rmCat}   />
            <CategoryCheckBox category='Current Events' categories={tossupSettings.cat} addCategory={tossupSettings.addCat} removeCategory={tossupSettings.rmCat}   />
            <CategoryCheckBox category='Geography' categories={tossupSettings.cat} addCategory={tossupSettings.addCat} removeCategory={tossupSettings.rmCat}   />
            <CategoryCheckBox category='Other Academic' categories={tossupSettings.cat} addCategory={tossupSettings.addCat} removeCategory={tossupSettings.rmCat}   />
            <CategoryCheckBox category='Trash' categories={tossupSettings.cat} addCategory={tossupSettings.addCat} removeCategory={tossupSettings.rmCat}   />
            <Button onPress={() => tossupSettings.sCat(['Literature', 'History', 'Science', 'Fine Arts', 'Religion', 'Mythology', 'Philosophy', 'Social Science', 'Current Events', 'Geography', 'Other Academic', 'Trash'])}>Add all categories</Button>
          </Accordion.Content>
        </Accordion.Item>
      </Accordion>
    </ScrollView>
